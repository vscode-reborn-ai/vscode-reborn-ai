...
const App = () => (
  <div className="flex flex-col h-screen">
    ...
    >
      ...
      <div className="flex flex-col gap-4 h-full items-center justify-end text-center mb-8">
        <button
          ...
          className="hidden mb-4 btn btn-primary flex gap-2 justify-center p-3 rounded-md"
        ...
        <p className="max-w-sm text-center text-xs text-slate-500">
          ...
          <br />
          <a title="" id="settings-button" href="#">
            Update settings
          </a>
          &nbsp; | &nbsp;
          <a title="" id="settings-prompt-button" href="#">
            Update prompts
          </a>
        </p>
      </div>
    ...
    <div className="flex-1 overflow-y-auto hidden" id="conversation-list"></div>

    <div id="in-progress" className="pl-4 pt-2 flex items-center hidden">
    ...
    <div className="p-4 flex items-center pt-2">
      ...
      <div
        id="model-button-wrapper"
        className="absolute bottom-14 items-center more-menu right-8 border border-gray-200 shadow-xl hidden text-xs"
      >
        <button
          className="flex gap-2 items-center justify-start p-2 w-full"
